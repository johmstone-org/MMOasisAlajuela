-- ======================================================================
-- Name: [usr].[uspGenerateGUIDResetPassword]
...
CREATE PROCEDURE [usr].[uspGenerateGUIDResetPassword]
	@Email		VARCHAR(50)
AS 
    BEGIN
        SET NOCOUNT ON
            ...
            -- =======================================================
				...
				IF(@UserID IS NOT NULL)
					BEGIN
						...
						INSERT INTO [usr].[utbResetPasswords] ([GUID],[UserID],[InsertUser],[LastModifyUser])
